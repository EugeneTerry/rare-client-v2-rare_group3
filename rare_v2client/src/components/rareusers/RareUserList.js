...
export const RareUserList = () => {
  ...
  return (
    <article className="rareuser_wrapper"> 
      ...
      <section>
        <header className="user_info"><h3>Here is your profile</h3></header>
      </section>
        <div className="user_header">
          <div>
          <ul>
           <img className="profile_image" src={currentUser.profile_image_url} /> 
          </ul>
          <ul>
            <b>Full Name:</b> {""} {currentUser.user?.first_name} {""}{currentUser.user?.last_name}
          </ul>
          <ul>
